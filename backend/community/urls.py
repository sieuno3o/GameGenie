...
urlpatterns = [
    ...
    path('<int:pk>/', views.CommunityDetail.as_view(), name='detail'),  # 게시글 조회, 수정
    ...
    path('comments/<int:community_id>/<int:comment_id>/',
         views.CommentDetail.as_view(), name='comment_update'),  # 댓글 수정
    ...
    path('replies/<int:comment_id>/<int:reply_id>/',
         views.ReplyDetail.as_view(), name='reply-update'),  # 대댓글 수정
